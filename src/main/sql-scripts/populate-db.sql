...
values
(100, 1, 'Медовик', 254.30, 10, current_timestamp, true);
...
(id, name, quantity, quantity_type, cost)
values
(10000, 'Яйца', 10, 'PIECE', 75),
(10001, 'Сахар', 1000, 'GRAM', 35),
(10002, 'Мед', 1000, 'GRAM', 350),
(10003, 'Мука', 2000, 'GRAM', 80),
(10004, 'Растительное масло', 925, 'GRAM', 75),
(10005, 'Сода', 0, 'GRAM', 0),

(10006, 'Сметана', 350, 'GRAM', 80),
(10007, 'Сахарная пудра', 1000, 'GRAM', 100),
(10008, 'Сливки 33%', 200, 'GRAM', 80),
(10009, 'Ваниль', 0, 'GRAM', 0),

(10010, 'Молоко', 1000, 'GRAM', 50),
(10011, 'Желтки', 10, 'PIECE', 75),
(10012, 'Яйца', 10, 'PIECE', 75),
(10013, 'Крахмал', 200, 'GRAM', 40),
(10014, 'Слив. масло', 180, 'GRAM', 120),
(10015, 'Сахар', 1000, 'GRAM', 35),

(10016, 'Сметана', 350, 'GRAM', 80),
(10017, 'Сливки 33%', 500, 'GRAM', 240),
(10018, 'Сахарная пудра', 1000, 'GRAM', 100),
(10019, 'Арахисовая паста', 500, 'GRAM', 500),

(10020, 'Творожный сыр', 170, 'GRAM', 70),
(10021, 'Сметана', 350, 'GRAM', 80),
(10022, 'Сливки 33%', 500, 'GRAM', 240),
(10023, 'Карамель', 300, 'GRAM', 450),

(10024, 'Упаковка', 1, 'PIECE', 50);
